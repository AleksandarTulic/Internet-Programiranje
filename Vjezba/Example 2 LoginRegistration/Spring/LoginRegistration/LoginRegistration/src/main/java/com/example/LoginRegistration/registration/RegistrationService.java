...
import com.example.LoginRegistration.registration.token.*;
import com.example.LoginRegistration.email.*;
import lombok.AllArgsConstructor;

@Service
@AllArgsConstructor
public class RegistrationService {
	@Autowired private final EmailValidator emailValidator = null;
	...
	@Autowired private final EmailSender emailSender = null;
